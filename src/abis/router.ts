export const routeAbi = [
  ...
  { inputs: [], name: 'INSUFFICIENT_ETH', type: 'error' },
  { inputs: [], name: 'INSUFFICIENT_TOKEN', type: 'error' },
  { inputs: [], name: 'INVALID_BIPS', type: 'error' },
  { inputs: [], name: 'INVALID_PATH', type: 'error' },
  { inputs: [], name: 'INVALID_RESERVES', type: 'error' },
  { inputs: [], name: 'INVALID_SPENDER', type: 'error' },
  {
  ...
  { inputs: [], name: 'V2INVALID_PATH', type: 'error' },
