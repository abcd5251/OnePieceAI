export const beetsAbi = [
  ...
  { inputs: [], name: 'DelegateAmountCannotBeZero', type: 'error' },
  { inputs: [], name: 'DepositPaused', type: 'error' },
  { inputs: [], name: 'DepositTooSmall', type: 'error' },
  { inputs: [], name: 'DonationAmountCannotBeZero', type: 'error' },
  { inputs: [], name: 'DonationAmountTooSmall', type: 'error' },
  ...
  { inputs: [], name: 'PausedValueDidNotChange', type: 'error' },
  { inputs: [], name: 'ProtocolFeeTooHigh', type: 'error' },
  { inputs: [], name: 'ProtocolFeeTransferFailed', type: 'error' },
  { inputs: [], name: 'ReentrancyGuardReentrantCall', type: 'error' },
  { inputs: [], name: 'RewardsClaimedTooSmall', type: 'error' },
  { inputs: [], name: 'SFCAddressCannotBeZero', type: 'error' },
  { inputs: [], name: 'SenderNotSFC', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'refundRatio', type: 'uint256' }],
    name: 'SfcSlashMustBeAccepted',
    type: 'error',
  },
  { inputs: [], name: 'TreasuryAddressCannotBeZero', type: 'error' },
  ...
  { inputs: [], name: 'UndelegateAmountCannotBeZero', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'validatorId', type: 'uint256' }],
    name: 'UndelegateAmountExceedsDelegated',
    type: 'error',
  },
  { inputs: [], name: 'UndelegateAmountExceedsPool', type: 'error' },
  { inputs: [], name: 'UndelegateAmountTooSmall', type: 'error' },
  { inputs: [], name: 'UndelegateFromPoolPaused', type: 'error' },
  { inputs: [], name: 'UndelegatePaused', type: 'error' },
  { inputs: [], name: 'UnsupportedWithdrawKind', type: 'error' },
  { inputs: [], name: 'UserWithdrawsMaxSizeCannotBeZero', type: 'error' },
  { inputs: [], name: 'UserWithdrawsSkipTooLarge', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'withdrawId', type: 'uint256' }],
  ...
  { inputs: [], name: 'WithdrawsPaused', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'bool', name: 'emergency', type: 'bool' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'SFC',
    outputs: [{ internalType: 'contract ISFC', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'contract ISFC', name: '_sfc', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'newFeeBIPS', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'withdrawId', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'undelegateMany',
    outputs: [
      { internalType: 'uint256[]', name: 'withdrawIds', type: 'uint256[]' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'numWithdraws', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
